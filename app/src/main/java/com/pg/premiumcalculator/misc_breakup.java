...
public class misc_breakup extends menu {
    ...
    {
        rate = mrate.getRate(basicVehicleDetails.getVehicle(),basicVehicleDetails.getZone(),basicVehicleDetails.getDateOfRegistration());
        basicTP=mrate.getTP(basicVehicleDetails.getVehicle(),basicVehicleDetails.getVehicleUse(),basicVehicleDetails.getVehicleType());
...
//                    createFileBuilder();
                    ...
                    try {
                        ...
                        pdfGenerator.generatePdf(getApplicationContext(),misc_breakup.this,basicData,odData,tpData,finalData);
                        fileid++;
