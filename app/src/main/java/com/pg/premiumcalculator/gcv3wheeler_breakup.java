...
public class gcv3wheeler_breakup extends AppCompatActivity {
    ...
    TextView idvview,dateview,zoneview,ccview,rateview,basicodview,elecview,nonelecview,oddiscview,ncbview,zerodepview,totalaview,basictpview,tppdview,ownerpaview,lltodriverview,totalbview,totalabview,gstview,finalview,imt23view,carrierview,cngview,extcngkitview,cngtpview;
    //text views pointers
