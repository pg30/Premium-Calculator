...
public class gcv3wheeler_breakup extends menu {
    ...
    {
        rate = mrate.getRate(basicVehicleDetails.getZone(),basicVehicleDetails.getVehicle(),basicVehicleDetails.getDateOfRegistration(),basicVehicleDetails.getCarrier());
        basicTP=mrate.getTP(basicVehicleDetails.getVehicle(),basicVehicleDetails.getCarrier());
...
//                    createFileBuilder();
                    ...
                    try {
                        ...
                        pdfGenerator.generatePdf(getApplicationContext(),gcv3wheeler_breakup.this,basicData,odData,tpData,finalData);
                        fileid++;
