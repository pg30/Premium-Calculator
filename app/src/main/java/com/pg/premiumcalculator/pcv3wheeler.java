...
public class pcv3wheeler extends menu implements AdapterView.OnItemSelectedListener {
    ...
    void findViews()
    {
        ...
        date_edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                datePickerDialog = new DatePickerDialog(pcv3wheeler.this, AlertDialog.THEME_HOLO_LIGHT,new DatePickerDialog.OnDateSetListener() {
