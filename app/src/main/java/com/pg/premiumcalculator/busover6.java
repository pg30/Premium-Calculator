...
public class busover6 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    void findViews()
    {
        ...
        date_edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                datePickerDialog = new DatePickerDialog(busover6.this,new DatePickerDialog.OnDateSetListener() {
