...
public class schoolbus_breakup extends AppCompatActivity {
...
//    EditText file_edit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_schoolbus_breakup);
    ...
    {
        rate = mrate.getRate(zone,currVehicle,dateofregistration,noofpassenger);
        tpPassenger = mrate.getPerPassenger(noofpassenger,currVehicle);
    ...
    void getValuesFromIntent()
    {
        ...
        Bundle b = intent.getBundleExtra("schoolbus_breakup_bundle");
        idv = b.getDouble("idv");
    ...
    {
        AlertDialog.Builder company_builder = new AlertDialog.Builder(schoolbus_breakup.this);
        ...
        ArrayAdapter<CharSequence> company_adapter =  ArrayAdapter.createFromResource(schoolbus_breakup.this,R.array.company_list,R.layout.support_simple_spinner_dropdown_item);
        ...
        company_builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (!company_spinner.getSelectedItem().toString().equalsIgnoreCase("Choose an insurer…")) {
                    ...
                    dialog.dismiss();
//                    createFileBuilder();
                    int fileid = new PrefManager(getApplicationContext()).getSchoolBusId();
                    pdfname = "SCHOOLBUS_"+fileid+".pdf";
                    try {
                        createPdfWrapper();
                        fileid++;
                        new PrefManager(getApplicationContext()).setSchoolBusId(fileid);
                        shareFile();
