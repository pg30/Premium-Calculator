...
public class gcv_breakup extends menu {
    ...
    {
        rate = mrate.getRate(basicVehicleDetails.getZone(),basicVehicleDetails.getVehicle(),basicVehicleDetails.getDateOfRegistration(),basicVehicleDetails.getCarrier(),basicVehicleDetails.getGrossVehicleWeight());
...
//                    createFileBuilder();
                    ...
                    try {
                        ...
                        pdfGenerator.generatePdf(getApplicationContext(),gcv_breakup.this,basicData,odData,tpData,finalData);
                        fileid++;
