...
public class busover6_breakup extends menu {
    ...
    void calculatePremium()
    {
        ...
        double additionalOD = mrate.getAdditionalOD(basicVehicleDetails.getVehicle(),basicVehicleDetails.getSeatingCapacity());
...
//                    createFileBuilder();
                    ...
                    try {
                        ...
                        pdfGenerator.generatePdf(getApplicationContext(),busover6_breakup.this,basicData,odData,tpData,finalData);                        fileid++;
