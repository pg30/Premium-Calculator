...
public class taxilessthan6_breakup extends menu {
    ...
    {
        rate = mrate.getRate(basicVehicleDetails.getZone(),basicVehicleDetails.getVehicle(),basicVehicleDetails.getCubicCapacity(),basicVehicleDetails.getDateOfRegistration());
        tpPassenger = mrate.getPerPassenger(basicVehicleDetails.getVehicle(),basicVehicleDetails.getCubicCapacity());
        basicTP=mrate.getTP(basicVehicleDetails.getVehicle(),basicVehicleDetails.getCubicCapacity());
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (!company_spinner.getSelectedItem().toString().equalsIgnoreCase("Choose an insurer…")) {
                    ...
                    try {
                        ...
                        pdfGenerator.generatePdf(getApplicationContext(),taxilessthan6_breakup.this,basicData,odData,tpData,finalData);
                        fileid++;
